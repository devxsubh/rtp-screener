...
import { getWorkflow, updateWorkflow } from "@/app/lib/rtpGlobalApi";
...
import type { ColumnConfig, RtpWorkflow } from "@/app/components/shared/types";
import {
    BUILT_IN_IDS,
    BUILT_IN_WORKFLOWS,
...
export default function WorkflowDetailPage({ params }: Props) {
    ...
    const [workflow, setWorkflow] = useState<RtpWorkflow | null>(null);
