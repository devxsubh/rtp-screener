...
export default function ProjectAssistantChatPage({ params }: Props) {
    ...
    useEffect(() => {
        ...
        getChat(chatId)
            ...
            .catch(() => router.replace(`/startups/${projectId}?tab=assistant`))
    ...
    async function handleDeleteChat() {
        ...
        try {
            ...
            router.push(`/startups/${projectId}?tab=assistant`);
        } finally {
            ...
            <div className="flex flex-1 min-h-0 border-t border-gray-200 overflow-hidden">
                ...
                {!explorerCollapsed && (
                    <>
                        ...
                        <ResizeDivider onDrag={onExplorerDividerDrag} />
                    </>
                )}
                ...
                <ResizeDivider onDrag={onChatDividerDrag} />
