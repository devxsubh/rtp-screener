...
export function ScreeningResultsContent({
  ...
  return (
    <>
      ...
      {embedded && (
        <div className="px-4 pt-3 pb-1 shrink-0 border-b border-gray-100">
      ...
      <div
        className={`flex-1 overflow-y-auto p-4 space-y-6 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden ${embedded ? "min-h-0" : ""}`}
      >
        <section>
          <h3 className="text-xs font-semibold text-gray-700 mb-2 uppercase tracking-wide">
            Ownership graph
          </h3>
          <div className="rounded-lg border overflow-hidden h-[360px]">
            <OwnershipGraph
      ...
      {!startupId && handoffFilename && onContinueInStartup && (
        <div className="shrink-0 border-t border-gray-100 px-4 py-3 bg-gray-50">
          <button
            ...
            className="w-full rounded-lg bg-gray-900 px-3 py-2 text-xs font-medium text-white hover:bg-gray-700 transition-colors"
          >
