...
import type { RtpChat, RtpMessage } from "@/app/components/shared/types";
...
interface ChatHistoryContextType {
    ...
    newChatMessages: RtpMessage[] | null;
    setNewChatMessages: (messages: RtpMessage[] | null) => void;
    replaceChatId: (
        oldChatId: string,
        newChatId: string,
        title?: string,
...
export function ChatHistoryProvider({ children }: { children: ReactNode }) {
    const { user } = useAuth();
    const [chats, setChats] = useState<RtpChat[] | null>(null);
